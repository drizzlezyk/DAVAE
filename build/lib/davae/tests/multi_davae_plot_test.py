...
# davae_path = 'dann_vae/ifnb/davae_01.h5ad'
...
figure_merge = base_path + 'dann_vae/benchmark1/compare02.png'
...
ax.scatter(data_davae_emb[:, 0], data_davae_emb[:, 1], c=batches, cmap=batch_cmap, s=size)

plt.xlabel(xy_label + '1')
plt.ylabel(xy_label + '2')

ax = fig.add_subplot(257)
ax.scatter(data_davae_emb[:, 0], data_davae_emb[:, 1], c=label, cmap=c_map, s=size)
