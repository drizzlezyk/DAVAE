...
# filt_label_num = tools.text_label_to_number(filt_label)
# print(filt_label_num.shape)
# adata_orig.obs['label'] = filt_label_num
# adata_orig.obs['celltype'] = filt_label
...
#
# print(filt_label, filt_label_num)
#
...
orig_data = adata.X
batches = to_categorical(orig_batch_label)
loss_weights = orig_batch_label

data, batch, loss_weights = shuffle(orig_data, batches, loss_weights, random_state=0)
#
# batch_label = np.array(batch_label)
print(adata.shape)
# #
...
x = net.embedding(orig_data, batch)
